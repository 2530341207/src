...
function on_timer_award(map, timer_id)
    ...
    lualib:SysMsg_SendMapMsg(map, lualib:Player_GetStrProp(player, lua_role_user_name).."→→被宝盒的神秘力量笼罩，获得了#OFFSET<X:13,Y:0>##IMAGE<ID:1902700032>##IMAGE<ID:1902700032>##IMAGE<ID:1902700032>##IMAGE<ID:1902700032>##IMAGE<ID:1902700032>#大量元宝！")
end
