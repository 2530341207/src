...
-----------------------图标显示-----------------------------
function dayCharge(player,line,pos)
...
function main(player)
    ...
    local ingots = lualib:GetDBNum("mrcz"..id..lualib:GetAllDays(0))            --每日充值
    local receiveNum = lualib:GetDBNum("receiveNum"..id..lualib:GetAllDays(0))                        --已经领取的次数
...
function receive(player,num)
    ...
    local id  =  lualib:UserID(player)
    local ingots = lualib:GetDBNum("mrcz"..id..lualib:GetAllDays(0))            --累计充值
    local receiveNum = lualib:GetDBNum("receiveNum"..id..lualib:GetAllDays(0))                        --已经领取的次数
    local data = ""
    ...
    lualib:SetDBNumEx("receiveNum"..id..lualib:GetAllDays(0),lualib:GetDBNum("receiveNum"..id..lualib:GetAllDays(0))+1,2)
    receiveNum = lualib:GetDBNum("receiveNum"..id..lualib:GetAllDays(0))
