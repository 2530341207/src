...
local _Handle = 0
local txt = {
    "时装仓库可存放25件时装，除单件增加属性外，存入到5.10.15.20件能额外获得属性，时装仓库属性请在人物装备框“状态栏”查看",
    "单件属性详细说明:",
    "普通时装属性:",
    "S级时装属性:",
    "每件增加2-2攻击力",
...
function warehouse.main()
    ...
    local str = [[
		<form>
			<dialog id="frameWarehouse" image="0" w="800" h="580" x="0" y="0" close="false" esc_close="true" drag="true" center="true" revmsg="true" OnInit="warehouse.Init" magic="1">
				<image id="Img1" x="0" y="0" w="800" h="600" image="4000040000" fitsize="true" gray="false" />
				<richedit id="Txt1" x="343" y="60" w="80" h="30" text="时装仓库" text_color="GOLD" canedit="false" font="SIMLI18" />
				<wnd id="wnd1" x="0" y="0" w="800" h="580">
					...
					<image id="wnd1_Img14" x="218" y="125" w="60" h="60" image="1803900001" fitsize="true" gray="false" />
					<image id="wnd1_Img14" x="218" y="125" w="60" h="60" image="1803900001" fitsize="true" gray="false" />
					<richedit id="wnd1_Txt2" x="90" y="480" w="600" h="30" text=]]..txt[1]..[[ text_color="DARK" canedit="false" font="SIMLI18"  />
					<richedit id="wnd1_Txt3" x="550" y="500" w="600" h="30" text="详细情况" text_color="GOLD" canedit="false" font="SIMLI18" revmsg="true" param="1" OnLButtonClick="warehouse.detailed"/>
				</wnd>
				<wnd id="wnd2" x="0" y="0" w="800" h="580">
					...
					<richedit id="wnd2_Txt1" x="90" y="480" w="600" h="30" text=]]..txt[1]..[[ text_color="DARK" canedit="false" font="SIMLI18"/>
					<richedit id="wnd2_Txt2" x="550" y="500" w="80" h="30" text="返回首页" text_color="GOLD" canedit="false" font="SIMLI18" revmsg="true" param="2" OnLButtonClick="warehouse.detailed"/>
					<richedit id="wnd2_Txt3" x="90" y="130" w="180" h="30" text=]]..txt[2]..[[ text_color="YELLOW" canedit="false" font="SIMLI18"/>
					<richedit id="wnd2_Txt4" x="90" y="155" w="130" h="30" text=]]..txt[3]..[[ text_color="DARK" canedit="false" font="SIMLI18"/>
					<richedit id="wnd2_Txt5" x="90" y="180" w="130" h="30" text=]]..txt[4]..[[ text_color="DARK" canedit="false" font="SIMLI18"/>
					<richedit id="wnd2_Txt6" x="210" y="160" w="200" h="30" text=]]..txt[5]..[[ text_color="GREENG" canedit="false" font="system"/>
					<richedit id="wnd2_Txt7" x="210" y="185" w="200" h="30" text=]]..txt[6]..[[ text_color="GREENG" canedit="false" font="system"/>
					<richedit id="wnd2_Txt8" x="90" y="205" w="200" h="30" text=]]..txt[7]..[[ text_color="YELLOW" canedit="false" font="SIMLI18"/>
...
function warehouse.detailed(this)
    ...
    if num == 1 then
        ...
        for i=1,10 do
            ...
            positionY = 230
            local _WndHandle = GetWindow(0,"frameWarehouse,wnd2")
            local _EditHandle = GUI:RichEditCreate(_WndHandle,"wnd2_txt"..(num + i),positionX,positionY + (i-1)*25,120,30)
            if _EditHandle ~= 0 then
                RichEditSetProp(_EditHandle,"",true,false,true,SIMLI18,GUI:MakeColor(255, 0, 255, 255),txt[i+7])
            end
            ...
            positionY = 230
            local _WndHandle = GetWindow(0,"frameWarehouse,wnd2")
            local _EditHandle = GUI:RichEditCreate(_WndHandle,"wnd2_txt"..(num + i),positionX,positionY + (i-1)*25,300,30)
            if _EditHandle ~= 0 then
                RichEditSetProp(_EditHandle,"",true,false,true,SIMLI18,GUI:MakeColor(255, 0, 255, 255),txt[i+17])
            end
        end
