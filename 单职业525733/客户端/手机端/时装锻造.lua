...
function Fashion.main()
    ...
    local str = [[
	<form>
		<dialog id=时装界面 x=0 y=0 w=700 h=600  image=0 center=1 close=0 savepos=1 magic=1 OnInit=Fashion.Init>
			<image id="右背景" x=-25 y=-50 w=700 h=600 image="4000800000" fitsize=true/>
			
			<wnd id="wnd1" x=0 y=0 w=309 h=395>
				<image id="右背景" x=368 y=76 w=245 h=415  type="around" image="1855027000,1855027002,1855027006,1855027008,1855027004,1855027001,1855027007,1855027003,1855027005" fitsize=true/>
				<image id="左背景" x=30 y=76 w=342 h=415 type="around" image="1855027000,1855027002,1855027006,1855027008,1855027004,1855027001,1855027007,1855027003,1855027005" fitsize=true/>
				<richedit id="标题1" x=455 y=80 w=200 h=15 text_color="BROWN" text="左侧时装属性"/>
				<richedit id="属性1" x=375 y=125 w=200 h=15 text_color="white" text="防    御："/>
				<richedit id="属性2" x=375 y=165 w=200 h=15 text_color="white" text="魔    御："/>
				<richedit id="属性3" x=375 y=205 w=200 h=15 text_color="white" text="攻    击："/>
				<richedit id="属性4" x=375 y=245 w=200 h=15 text_color="white" text="魔    法："/>
				<richedit id="属性5" x=375 y=285 w=200 h=15 text_color="white" text="道    术："/>
				<richedit id="属性6" x=375 y=325 w=200 h=15 text_color="white" text="暴击几率："/>
				<richedit id="属性7" x=375 y=365 w=200 h=15 text_color="white" text="人物爆率："/>
				<richedit id="属性8" x=375 y=405 w=200 h=15 text_color="white" text="防爆几率："/>
				<richedit id="显示1" x=475 y=125 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示2" x=475 y=165 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示3" x=475 y=205 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示4" x=475 y=245 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示5" x=475 y=285 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示6" x=475 y=325 w=200 h=15 text_color="YELLOW" text="0-0"/>
				<richedit id="显示7" x=475 y=365 w=200 h=15 text_color="YELLOW" text="0"/>
				<richedit id="显示8" x=475 y=405 w=200 h=15 text_color="YELLOW" text="0"/>


				<itemctrl id=武器 x=83 y=383 w=44 h=44 use_back=false revmsg=false/>
				<itemctrl id=衣服 x=177 y=295 w=44 h=44 use_back=false />


				<button id="上页" x="40" y="270" image="1800000192" param=1 OnLButtonClick="Fashion.MakePage"/>
				<button id="下页" x="303" y="270" image="1800000196" param=2 OnLButtonClick="Fashion.MakePage"/>

				<image id="标题框" x=95 y=445 image="1805900017"/>
				<edit id="标题名" x="150" y="455" w="200" h="20" text_color="YELLOW" text="" font="SIMLI18"  />
			...
			<wnd id="wnd2" x=0 y=0 w=309 h=395>
				...
				<richedit id="wnd2_txt1" x="110" y="90" w="80" h="20" text="放入时装" text_color="YELLOW" font="system"/>
				<richedit id="wnd2_txt2" x="280" y="90" w="80" h="20" text="放入时装" text_color="YELLOW" font="system"/>
				<richedit id="wnd2_txt3" x="450" y="90" w="80" h="20" text="放入时装" text_color="YELLOW" font="system"/>
				...
				<image id="物品框背景1" x="110" y="120" w="80" h="80" image="1806500008" fitsize="true" gray="false"/>
				<itemctrl id="物品框1" x="123" y="135" w="55" h="55" auto_manage="true" rbtn_use="false" invalid="true" is_bound="false" init_item="" use_back="false" param="1" OnLButtonClick="Fashion.onBtnC" OnItemMoveIn="Fashion.OnItemMoveIn" />

				<image id="物品框背景2" x="280" y="120" w="80" h="80" image="1806500008" fitsize="true" gray="false"/>
				<itemctrl id="物品框2" x="293" y="135" w="55" h="55" auto_manage="true" rbtn_use="false" invalid="true" is_bound="false" init_item="" use_back="false" param="2" OnLButtonClick="Fashion.onBtnC" OnItemMoveIn="Fashion.OnItemMoveIn" />

				<image id="物品框背景3" x="450" y="120" w="80" h="80" image="1806500008" fitsize="true" gray="false"/>
				<itemctrl id="物品框3" x="463" y="135" w="55" h="55" auto_manage="true" rbtn_use="false" invalid="true" is_bound="false" init_item="" use_back="false" param="3" OnLButtonClick="Fashion.onBtnC" OnItemMoveIn="Fashion.OnItemMoveIn" />

				<image id="物品框背景4" x="280" y="220" w="80" h="80" image="1806500008" fitsize="true" gray="false"/>
				<itemctrl id="物品框4" x="293" y="235" w="55" h="55"  init_item=""  use_back="false" />

				<richedit id="wnd2_txt4" x="160" y="300" w="500" h="20" text="三件同样时装可以合成一件S级时装" text_color="DARK" font="system"/>
				<richedit id="wnd2_txt5" x="120" y="330" w="500" h="20" text="合成需要元宝并且合成的S级时装不能在合成" text_color="DARK" font="system"/>
				<richedit id="wnd2_txt6" x="160" y="360" w="500" h="20" text="合成时装,把时装放入上面三个框内" text_color="DARK" font="system"/>
				<richedit id="wnd2_txt7" x="230" y="395" w="100" h="20" text="所需元宝：" text_color="YELLOW" font="system"/>
				...
				<button id="wnd2_btn1" x="180" y="430" image="1852500055" text="自动放入" text_color="GOLD2" param=1 OnLButtonClick="Fashion.into" />
				<button id="wnd2_btn2" x="340" y="430" image="1852500055" text="时装合成" text_color="GOLD2" param=1 OnLButtonClick="Fashion.synthesis" />

			</wnd>
			<richedit id="标题" x="250" y="0" w="100" h="20" text="时装锻造" text_color="YELLOW" font="SIMLI18"/>
			<button id="时装锻造" x="50" y="45" image="1804100010" text="锻造" text_color="GOLD2" param=1 OnLButtonClick="Fashion.duanzao" />
			<button id="时装强化" x="125" y="45" image="1804100010" text="强化" text_color="GOLD2" param=1 OnLButtonClick="Fashion.qianghua" />
			<button id="关闭" x="550" y="-16" image="4000230000" OnLButtonClick="Fashion.Closed" />
		</dialog>
	</form>
	]]
    GenFormByString(str)
